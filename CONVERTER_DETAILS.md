# Technical Details: Keysight / Agilent 3070 ICT (legacy flat-file format)
...
- Converter submits with `SubmitMethod.Offline` â€” records are queued for later upload
...
| `stationname` | `test-machine` | <!-- TODO: describe effect --> |
| `sequenceFile` | `seqName` | <!-- TODO: describe effect --> |
